...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        B, L, C = x.shape
        assert L == H * W, "输入特征维度不匹配"
        assert H % 2 == 0 and W % 2 == 0, f"x size ({H}*{W}) 不是2的倍数"
...
class BasicLayer(nn.Module):
    """
    基础Swin Transformer层,包含多个Swin Transformer Block
    """
...
if __name__ == '__main__':
    ...
    print("Swin Transformer输出特征:")
    for i, feat in enumerate(features):
        print(f"X{i+1} shape: {feat.shape}")
